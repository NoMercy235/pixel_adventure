...
class Fruit extends SpriteAnimationComponent with HasGameRef<PixelAdventure>, CollisionCallbacks {
  ...
  FutureOr<void> onLoad() {
    ...
    animation = SpriteAnimation.fromFrameData(
      ...
      SpriteAnimationData.sequenced(amount: 17, stepTime: animationPlayTime, textureSize: Vector2.all(Constants.textureSize.value)),
    );
    return super.onLoad();
  }
  ...
  void handlePlayerCollision() {
    ...
    animation = SpriteAnimation.fromFrameData(
      ...
      SpriteAnimationData.sequenced(amount: 6, stepTime: animationPlayTime, textureSize: Vector2.all(Constants.textureSize.value), loop: false),
    );
